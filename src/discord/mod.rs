...
pub use adapter::{
    ...
    extract_media_directives, format_channel_context, format_runtime_footer, global_debouncer,
    is_authorized_clicker, is_discord_dead_target_error, is_silence_response, is_voice_audio_file,
    safe_allowed_mentions, should_chunk_reference, AllowBotsMode, DeadTargetEntry,
